...
(function (global, factory) {
	...
	(global = global || self, factory(global.ava2json = {}, global.util, global.fs, global.path));
}(this, (function (exports, util, fs, path) { 'use strict';
	...
	function stripJsdocComment (jsDocCommentBlock, replaceValue = '') {
	  return trim_1(jsDocCommentBlock.replace(/^ \* ?/mgsi, ''))
	}

	const avaAvailableFlags = ['skip', 'only', 'todo'];
